...
### :large_blue_diamond: You can view the Raw SQL code I've used to explore the Database [HERE](https://github.com/CameronCSS/SQL-Queries/blob/main/EDA_2_RAW.SQL)
